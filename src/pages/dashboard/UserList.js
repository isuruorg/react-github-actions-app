      ...
      <Container>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, name, email, role, active, organization } = row;
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={name} src="static/mock-images/avatar-default.jpg" />
                        ...
                        <TableCell align="left">{userRoles[role]}</TableCell>
                        <TableCell align="left">
                          <Label
                            variant={theme.palette.mode === 'light' ? 'ghost' : 'filled'}
                            color={active ? 'success' : 'error'}
                          >
                            {sentenceCase(active ? 'active' : 'inactive')}
                          </Label>
                        </TableCell>
                        ...
                        <TableCell align="right">
                          <UserMoreMenu onDelete={() => handleDeleteUser(_id)} userName={name} userId={_id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
        ...
        {showPwdResetModal && (
          <PasswordResetConfirmationModal
            open={showPwdResetModal}
            onClose={() => setShowPwdResetModal(false)}
            user={selectedUser}
          />
        )}
      </Container>
